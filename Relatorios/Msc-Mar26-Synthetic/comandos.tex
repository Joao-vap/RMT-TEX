      ...
      \vspace*{-3cm}
       ...
       \linespread{1}
        \ifdefined\tipoRelat
        	\tipoRelat
        \fi
       \large Synthetic Report 
       for the 
       \ifdefined\modProjeto
        	\modProjeto
       \fi
        project, fomented by \agFom. \\ 
   	   \HRule{1.5pt} \\ [0.5cm]
       ...
       \fi
        \ifdefined\numAssocFAP
       Associated to Project \siglaAgFom~\texttt{\#\numAssocFAP}
       \\ [0.5cm]
       \fi
        Supervisor: \nomeAutor
...
\newcommand{\folhaDeRosto}{
   \chapter*{Project's General Information}
   \addcontentsline{toc}{chapter}{Project's General Information}
   \begin{itemize}
      \item Project Title: 
            \begin{itemize}\item[] \textbf{\meuTitulo} \end{itemize}
      \item Supervising Researcher: 
      ...
      \item Research team:
          ...
          \fi  
          \ifdefined \numAssocFAP
          \item Associated research project number:
          \begin{itemize}
          	\item[]\textbf{\numAssocFAP} 
          \end{itemize}
          \fi  
       \item Project effect dates:
            \begin{itemize}
               \item[]\textbf{\periodRelat} 
            \end{itemize}
       \item Dates covered by this report:
            \begin{itemize}
