...
We have seen that the study of eigenvalues of random matrices is of interest and can be seen as a point process. For some specific models, one can further find a more rigid structure related to determinantal point processes. These allow us to see eigenvalue distribution in terms of some correlation Kernel much easier to deal with than the initial formulation. Now, we will see that eigenvalue dynamics for invariant models can be though of as another DDP: The so called \textit{Coulomb Gases}. These can be though of as a physical gas of repelling ions restricted to some conductor under some confining potential. Although it may be daunting to have it another model to work with, these gases lead us directly to some nice interpretations and results. Namely, one can thing of \textit{thermodynamic equilibrium} for a large enough number of particles and this makes complete sense in a physical setting. In our matrices, these equilibrium distributions refers to the univariate eigenvalue distribution, a very interesting characterization of a RMT model. On this chapter we will expand on these ideas.

The section on Equilibrium Measures was based on the works of \citeonline{saff2024logarithmic} and \citeonline{deiftorthogonal}.
...
Recall the expression for invariant ensembles in Definition \ref{Definition: polynomial ensemble}, note that, rearranging the terms in \autoref{Equation: Coulomb Gas Measure} and considering a logarithm interaction kernel we get
\begin{equation}
		...
		\begin{subfigure}{0.2\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[axis line style={opacity=0}, ticks=none,
					...
					\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a2t0.csv};
				\end{axis}
			\end{tikzpicture}
		...
		\begin{subfigure}{0.2\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[axis line style={opacity=0}, ticks=none,
					...
					\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a2t05.csv};
				\end{axis}
			\end{tikzpicture}
		\end{subfigure} \hfill
		\begin{subfigure}{0.2\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[axis line style={opacity=0}, ticks=none,
					...
					\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a2t1.csv};
				\end{axis}
			\end{tikzpicture}
		\end{subfigure} \hfill
		\begin{subfigure}{0.2\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[axis line style={opacity=0}, ticks=none,
					...
					\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a2t2.csv};
				\end{axis}
			\end{tikzpicture}
		\end{subfigure} \hfill
	\end{figure}
	\begin{figure}[H]
		...
		\begin{tikzpicture}
			\begin{axis}[axis line style={opacity=0}, ticks=none,
				...
				\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a3t0.csv};
			\end{axis}
		\end{tikzpicture}
	\end{subfigure} \hspace{1cm}
		\begin{subfigure}{0.2\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}[axis line style={opacity=0}, ticks=none,
				...
				\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a3t05.csv};
			\end{axis}
		\end{tikzpicture}
	\end{subfigure} \hfill
		\begin{subfigure}{0.2\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}[axis line style={opacity=0}, ticks=none,
				...
				\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a3t1.csv};
			\end{axis}
		\end{tikzpicture}
	\end{subfigure} \hfill
		\begin{subfigure}{0.2\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}[axis line style={opacity=0}, ticks=none,
				...
				\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a3t2.csv};
			\end{axis}
		\end{tikzpicture}
	\end{subfigure} \hfill
	\end{figure}
	\begin{figure}[H]
		...
		\begin{tikzpicture}
			\begin{axis}[axis line style={opacity=0}, ticks=none,
				...
				\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a5t0.csv};
			\end{axis}
		\end{tikzpicture}
	\end{subfigure} \hspace{1cm}
		\begin{subfigure}{0.2\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}[axis line style={opacity=0}, ticks=none,
				...
				\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a5t05.csv};
			\end{axis}
		\end{tikzpicture}
	\end{subfigure} \hfill
		\begin{subfigure}{0.2\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}[axis line style={opacity=0}, ticks=none,
				...
				\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a5t1.csv};
			\end{axis}
		\end{tikzpicture}
	\end{subfigure} \hfill
		\begin{subfigure}{0.2\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}[axis line style={opacity=0}, ticks=none,
				...
				\addplot[opacity=0.04, scatter, mark=*,draw opacity=0,black, only marks] table [col sep=comma] {./plotdata/Symmetric/5lines/a5t2.csv};
			\end{axis}
		\end{tikzpicture}
	\end{subfigure} \hfill
...
Associated with the variational problem introduced on \autoref{Section: Equilibrium}
\begin{align}
...
\end{equation}
We don't want to deal with summations, in this context, integrals can be much easier to deal with. Then, we also want to convert the expression for the Hamiltonian. The confining term is easier, we can write
\begin{equation}
...
\end{equation}
The most important thing to notice here is that \autoref{Equation: logarithmic energyy - entropy} is of the form required for the Laplace asymptotic technique discussed in \autoref{chapter:asymptotics}. This means that t can be estimated, if $S$ has a maxima with strictly negative second derivative, by the evaluation at its maximum point. One can find 
\begin{align}
