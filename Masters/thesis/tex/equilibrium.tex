...
\begin{definicao}
	...
	\end{equation}
	is usually called the Hamiltonian, or more concretely, the configurational energy of the system. The function $\Q \colon \R^d \cong \Sigma \rightarrow \R$ is the external potential.
\end{definicao}
...
Recall the expression for invariant ensembles in \autoref{Definition: polynomial ensemble}, note that, rearranging the terms in \autoref{Equation: Coulomb Gas Measure} and considering a logarithm interaction kernel we get
\begin{equation}
