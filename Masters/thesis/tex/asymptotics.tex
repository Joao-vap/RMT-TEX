...
\begin{teorema} \label{Theorem: Euler-Maclaurin}(Euler-Maclaurin Formula,  \cite{NISTMathFunc})
...
The trapezoidal rule, for example, is a Riemann sum where $x_i^*$ is chosen to be the mean point $x_i^* = (x_{i-1} + x_i)/2$. In this way, we would estimate the area using trapezoids, as the name suggests. Then, we write
\begin{align}
