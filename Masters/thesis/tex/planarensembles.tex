...
\end{equation}
Now,  we have set the stage for the Laplace technique. Note that now $\tau$ will perform the function of the previous index $j$ and relates to which coefficient we are calculating. Taking a look at the first derivative of the newly defined potential we find that the critical point $r_c$ must satisfy
\begin{equation}
