...
\begin{teorema}
	...
	\begin{multline}
		\ln{\pZ{N}{}} = - N^2 I_Q[\mu_Q] + \frac{N}{2} \left( \ln(8\pi) - E_Q[\mu_Q] - 2\right) + \frac{N}{2} \ln(N) \\ + \frac{\ln(2\pi)}{2} + \frac{1}{2} \ln(N)+ F_V[A_{[r_0, r_1]}] + \Boh(N^{-1})        
	...
	and
	\begin{equation}
		E_Q[\mu_Q] \deff \frac{1}{2} \int_{r_0}^{r_1} \ln(V^{(2)}(s)) (sq'(s))' \dd s.
	\end{equation}
...
\begin{equation}
 \sum_{j=0}^{N-1} -N V_{\tau(j)}(r_{\tau(j)}) + \\ \frac{1}{2} \left(\ln(8\pi r^2_{\tau(j)}) - \ln N - \ln V^{(2)}_{\tau(j)}(r_{\tau(j)}) \right) + \frac{1}{N} \mathfrak{B}(r_{\tau(j)}) + \Boh(N^{-2}). 
...
\begin{teorema}		
	Asymptotically on $N$,
	\begin{equation}
		\sum_{j=0}^{N-1} \ln{h_j} = - N^2 I_Q[\mu_Q] - \frac{N}{2} \ln N + N \left(\frac{\ln(8\pi)}{2} - \frac{1}{2} E_Q[\mu_Q]\right) + F_V[A_{[r_0, r_1]}] + \Boh(N^{-1}) 
		%- N^2 I_Q[\mu_Q] - \frac{N}{2} \ln N + N \left(\frac{3\ln(2\pi)}{2} - \frac{1}{2} E_Q[\mu_Q]\right) \\ - \frac{1}{2} \ln\left(\frac{r_1}{r_0} \right) + \frac{1}{4} \ln\left(\frac{V^{(2)}_1(r_1)}{V^{(2)}_0(r_0)} \right) + \int_S \mathfrak{B} \dd \mu_Q + \Boh(N^{-1})
	\end{equation}
	where $F_V[A_{[r_0, r_1]}]$, $I_Q[\mu_Q]$, $	E_Q[\mu_Q]$ are as in Theorem \ref{Theorem: Annulus Free Energy}.
	%\begin{equation}
		%\mathfrak{B}(r_{\tau(j)}) = -\frac{V^{(4)}_{\tau(j)}(r_{\tau(j)})}{V^{(2)}_{\tau(j)}(r_{\tau(j)})^2} \frac{1}{8} - \frac{V^{(3)}_{\tau(j)}(r_{\tau(j)})}{V^{(2)}_{\tau(j)}(r_{\tau(j)})^{2}} \frac{1}{2 r_{\tau(j)}} - \frac{V^{(3)}_{\tau(j)}(r_{\tau(j)})^2}{V^{(2)}_{\tau(j)}(r_{\tau(j)})^{3}} \frac{5}{24}. %=\frac{V^{(4)}_{\tau(j)}(r_{\tau(j)})}{V^{(2)}_{\tau(j)}(r_{\tau(j)})^2} \frac{1}{4} - \frac{V^{(3)}_{\tau(j)}(r_{\tau(j)})}{V^{(2)}_{\tau(j)}(r_{\tau(j)})^{2}} \frac{19}{12 r_{\tau(j)}} - \frac{V^{(3)}_{\tau(j)}(r_{\tau(j)})^2}{V^{(2)}_{\tau(j)}(r_{\tau(j)})^{3}} \frac{5}{12} + \frac{1}{V^{(2)}_{\tau(j)}(r_{\tau(j)})} \frac{2}{3 r_{\tau(j)}^2},
	%\end{equation}
	%\begin{equation}
	%	I_Q[\mu_Q] = \left[\frac{1}{4} \int_{r_0}^{r_1} q(s) s V^{(2)}(s) \dd s- \ln(r_1) + \frac{1}{2} q(r_1) \right],
	%\end{equation}
	%and
	%\begin{equation}
...
\begin{equation}
	\sum_{j=0}^{N-1}\left(\ln(8\pi r^2_{\tau(j)}) - \ln V^{(2)}_{\tau(j)}(r_{\tau(j)}) \right).
\end{equation}
...
\begin{lema}
	...
	and
	\begin{equation}
		\sum_{j=0}^{N-1}  \ln(8\pi r^2_{\tau(j)}) = N \ln(8\pi) + 2 \left( - N U_{\mu_Q}(0) - \frac{1}{2} \ln\left(\frac{r_1}{r_0}\right) + \Boh(N^{-1}) \right) 
...
\begin{proof}
	...
	\begin{multline}
		\sum_{j=0}^{N-1}  \ln V^{(2)}_{\tau(j)}(r_{\tau(j)}) = \int_{0}^{N} \ln V^{(2)}_{\tau(t)}(r_{\tau(t)}) \dd t - \frac{1}{2} \ln \left( \frac{V^{(2)}_{1}(r_1)}{V^{(2)}_{0}(r_{0})} \right) + \\ \frac{1}{12} \left[ \partial_t \ln V^{(2)}_{\tau(t)}(r_{\tau(t)}) |_{t=N} - \partial_t \ln V^{(2)}_{\tau(t)}(r_{\tau(t)}) |_{t=0}\right]  + \Boh(N^{-3}).
	\end{multline}
	...
	And, noticing that
	\begin{equation}
		\partial_t \ln V^{(2)}_{\tau(t)}(r_{\tau(t)}) = \partial_V \left( \ln V^{(2)}_{\tau(t)}(r_{\tau(t)}) \right) \partial_r \left( V^{(2)}_{\tau(t)}(r_{\tau(t)}) \right) \partial_\tau \left( r_{\tau(t)} \right) = \frac{\left(\partial_r V^{(2)}\right)(r_{\tau(t)})}{r_{\tau(t)} \left( V^{(2)}_{\tau(t)}(r_{\tau(t)})\right)^2},
	\end{equation}
	we have for the third term on the right hand side, 
	\begin{align}
		\partial_t \ln V^{(2)}_{\tau(t)}(r_{\tau(t)}) |_{t=N} - \partial_t \ln V^{(2)}_{\tau(t)}(r_{\tau(t)}) |_{t=0} & = \frac{1}{2N} \left( \frac{\left(\partial_r V^{(2)}\right)(r_{1})}{r_1 \left( V^{(2)}_1(r_1)\right)^2} - \frac{\left(\partial_r V^{(2)}\right)(r_{0})}{r_0 \left( V^{(2)}_0(r_0)\right)^2}\right) \\ & = \Boh(N^{-1}).
	\end{align}
	Therefore,
	\begin{equation}
...
\begin{proof} (Theorem \ref{Theorem: Annulus sum})
	...
	\begin{multline}
			\sum_{j=0}^{N-1} \ln{h_j} = - N^2 I_Q[\mu_Q] + N U_{\mu_Q}(0) - \frac{1}{6} \ln{\left( \frac{r_0}{r_1}\right)}  - \frac{N}{2} \ln(N) - \frac{1}{2}  \left( N E_Q[\mu_Q] -  \frac{1}{2} \ln \left( \frac{V^{(2)}_{1}(r_1)}{V^{(2)}_{0}(r_{0})} \right) \right)	\\ + \frac{1}{2} \left( N \ln(8\pi) + 2 \left( - N U_{\mu_Q}(0) - \frac{1}{2} \ln\left(\frac{r_1}{r_0}\right) \right) \right)
...
\begin{teorema}
	...
	\begin{multline}
		\ln{\pZ{N}{}} =
		% - N^2 I_Q[\mu_Q]  -\frac{1}{2} N \ln N + N \left(\frac{\ln(4\pi)}{2} - 1- \frac{1}{2} E_Q[\mu_Q]\right) - \frac{5}{12} \ln N \\ + \frac{\ln(8\pi)}{2} + \frac{1}{2} \zeta'(-1) + \frac{1}{2} F_Q[D_{r_1}] + \frac{5}{4} \ln(2) + \frac{1}{8} \ln\left(\frac{V^{(2)}_0(0)}{V^{(2)}_1(r_1)}\right) + \Boh(N^{-1/12}(\ln N)^3)
	\end{multline}
	where we have set
%	\begin{equation}
	%	\mathfrak{B}(r_{\tau(j)}) \deff -\frac{V^{(4)}_{\tau(j)}(r_{\tau(j)})}{V^{(2)}_{\tau(j)}(r_{\tau(j)})^2} \frac{1}{8} - \frac{V^{(3)}_{\tau(j)}(r_{\tau(j)})}{V^{(2)}_{\tau(j)}(r_{\tau(j)})^{2}} \frac{1}{2 r_{\tau(j)}} - \frac{V^{(3)}_{\tau(j)}(r_{\tau(j)})^2}{V^{(2)}_{\tau(j)}(r_{\tau(j)})^{3}} \frac{5}{24},
...
\begin{teorema}
	...
	\begin{multline}
		\sum_{j=0}^{N-1} \ln (h_j) = -N^2 I[\mu_Q] - \frac{1}{2} N \ln(N)  -\frac{N}{2} \left( E_Q[\mu_Q] - \ln(8\pi) \right) - \frac{\ln(N)}{12} \\ + \zeta'(-1) + F_V[D_{r_1}] + \Boh(N^{-12} (\ln N)^3).
...
\begin{lema}
	...
	\begin{multline}
		\sum_{j=m_N}^{N-1} \ln (h_j) = -N^2 I[\mu_Q] + \frac{(N-m_N)}{2} \ln{\frac{8\pi}{N}} +  N m_N q(0) + \frac{3}{4} m_N^2 - \frac{N}{2} E_Q[\mu_Q] \\ - \frac{m_N}{2} \left(m_N + 1\right) \ln{\left(\frac{4}{V^{(2)}_0(0)}\right)} - \frac{1}{2} \left( m_N^2 - \frac{1}{6} \right) \ln{\left(\frac{m_N}{N}\right)} + F_V[D_{r_1}] + \Boh(N^{-12} (\ln N)^3).
	\end{multline}
	where $I_Q[\mu_Q] $,  $F_V[D_{r_1}]$ and $E_Q[\mu_Q]$ are as in Theorem \ref{Theorem: Disk Free Energy}.
	\label{Lemma: Summation disk >mn}
\end{lema}
...
\begin{align}
	& -N\sum_{j=m_N}^{N-1} V_{\tau(j)}(r_{\tau(j)}), \quad \sum_{j=m_N}^{N-1} \ln V^{(2)}_{\tau(j)}(r_{\tau(j)})  \quad \text{and} \quad \sum_{j=m_N}^{N-1}  \ln(r_{\tau(j)}).
\end{align}
...
\begin{proposicao}
	...
	\begin{equation}
		\sum_{j=m_N}^{N-1} \ln V^{(2)}_{\tau(j)}(r_{\tau(j)}) = N E_Q(\mu_Q)  - \frac{1}{2} \ln \left( \frac{V^{(2)}_{1}(r_1)}{V^{(2)}_{0}(r_{0})} \right)  - m_N \ln\left( V^{(2)}_0(0) \right) + \Boh(N^{-1/2(1-\epsilon)}),
	\end{equation}
...
\begin{proof}
	...
	\begin{align}
		...
		& = \int_{r_0}^{r_{\tau(m_N)}} \ln\left( V^{(2)}_0(0) + V^{(2)}_0(0) s + \Boh(s^2) \right) s \left( V^{(2)}_0(0) + V^{(2)}_0(0) s + \Boh(s^2) \right) \dd s, \\
		& = \int_{r_0}^{r_{\tau(m_N)}} \ln\left( V^{(2)}_0(0) \right) s V^{(2)}_0(0)  \dd s + \Boh(r_{\tau(m_N)}^3), \\
		& =  \ln\left( V^{(2)}_0(0) \right) r_{\tau(m_N)}^2 V^{(2)}_0(0) + \Boh(r_{\tau(m_N)}^3), \\
		& = \frac{2m_N}{N}\ln\left( V^{(2)}_0(0) \right)  + \Boh(N^{-3(1-\epsilon)}) 
	\end{align}
	...
	\begin{align}
		\partial_t \ln V^{(2)}_{\tau(t)}(r_{\tau(t)}) |_{t=N} - \partial_t \ln V^{(2)}_{\tau(t)}(r_{\tau(t)}) |_{t=m_N} & = \frac{2 \partial_r V^{(2)}(r_{1})}{ N r_1 \left( V^{(2)}_1(r_1)\right)^2} - \Boh\left( N/m_N \right)^{-1/2}, \\ 
		& =\Boh\left( N/m_N \right)^{-1/2} = \Boh(N^{-1/2(1-\epsilon)}).
	\end{align}
	Then, simply expanding the series on $V^{(2)}_{\tau(m_N)}(r_{\tau(m_N)})$, we can write,
	\begin{equation}
		\sum_{j=0}^{N-1}  \ln V^{(2)}_{\tau(j)}(r_{\tau(j)})  = N E_Q(\mu_Q)  - \frac{1}{2} \ln \left( \frac{V^{(2)}_{1}(r_1)}{V^{(2)}_{0}(0)} \right)  - m_N \ln\left( V^{(2)}_0(0) \right) + \Boh(N^{-1/2(1-\epsilon)}).
		\label{Equation: logV annulus}
	\end{equation}
...
\begin{proof} (Lemma \ref{Lemma: Summation disk >mn})
	...
	\end{multline}
	using Proposition \ref{Proposition: Behavior rt} and \autoref{Equation: behavior ln rt mn} we can rewrite
	\begin{equation}
a		
	\end{equation}
	\begin{equation}
...
\begin{proof} (Theorem \ref{Theorem: Disk Free Energy})
	From
	\begin{multline}
	\sum_{j=0}^{N} \ln(h_j) = - N^2 I_Q[\mu_Q]  -\frac{1}{2} N \ln N - \frac{N}{2} \left(E_Q[\mu_Q] - \ln(8\pi) \right) \\ - \frac{\ln N}{12} + \zeta'(-1) + F_V[D_{r_1}] + \Boh(N^{-1/12}(\ln N)^3)
	\end{multline}
	...
	\begin{align}
		...
		& =
		\begin{multlined}
			- N^2 I_Q[\mu_Q]  -\frac{1}{2} N \ln N + N \left(\frac{\ln(4\pi)}{2} - 1- \frac{1}{2} E_Q[\mu_Q]\right) - \frac{5}{12} \ln N \\ + \frac{\ln(8\pi)}{2} + \frac{1}{2} \zeta'(-1) + \frac{1}{2} F_V[D_{r_1}] + \frac{5}{4} \ln(2) + \frac{1}{8} \ln\left(\frac{V^{(2)}_0(0)}{V^{(2)}_1(r_1)}\right) + \Boh(N^{-1/12}(\ln N)^3)
		\end{multlined}
	\end{align}
\end{proof}
