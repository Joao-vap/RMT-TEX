...
O estudo do espectro de matrizes aleatórias demonstra aplicabilidade em uma gama diversa de áreas da física, matemática à computação e engenharia. Estudamos os principais ensembles da Teoria de Matrizes Aleatórias, em especial a medidas de equilíbrio de seus autovalores. Utilizando da analogia de Gases de Coulomb para as medidas nos autovalores, realizamos simulações que nos permitem calcular médias de funções de interesse sobre os microestados. Discute-se ainda importantes métodos para a simulação de dinâmica molecular e, especialmente, para o problema de gases de coulomb, focando nas principais limitações destas simulações, a escalabilidade e as singularidades do problema. Mostramos que o método de \textit{Langevin Monte Carlo} tem boa performance, possibilitando a réplica de medidas para modelos bem descritos de matrizes. Discute-se como esse resultado é importante e quais suas possíveis extensões.
\noindent
}
