...
\include{USPSC-TA-Textual/C1-Introducao/C1-Introducao}

% -
% C1S1 - Distribuição de autovalores
% - 
\section{Distribuição de autovalores}
\include{USPSC-TA-Textual/C1-Introducao/DistAutovalores.tex}

% -
% C1S2 - Emsembles Gaussianos
% - 
\section{Emsembles Gaussianos}
\include{USPSC-TA-Textual/C1-Introducao/EmsemblesGaussianos.tex}

% -
% C1S3 - Gases de Coulomb (Log Gas?)
% - 
\section{Gases de Coulomb}
\include{USPSC-TA-Textual/C1-Introducao/GasesDeCoulomb.tex}

% -
% C1S4 - Medidas de Equilíbrio
% - 
\section{Medidas de Equilíbrio}
\include{USPSC-TA-Textual/C1-Introducao/MedidaDeEquilibrio.tex}

% -
% C1S5 - Potenciais notáveis
% - 
\section{Potenciais notáveis}
\include{USPSC-TA-Textual/C1-Introducao/PotenciaisNotaveis.tex}

% ---
% Capítulo 2 - Simulações e Algoritmos
% ---

\include{USPSC-TA-Textual/C2-SimulacoesEAlgoritmos/C2-SimulacoesEAlgoritmos.tex}

% -
% C1S1 - Introdução ao algoritmo
% - 

\include{USPSC-TA-Textual/C2-SimulacoesEAlgoritmos/IntroducaoAoAlgoritmo.tex}

% -
% C1S2 - Algoritmo Híbrido de Monte Carlo
% - 

\include{USPSC-TA-Textual/C2-SimulacoesEAlgoritmos/AlgoritmoHibridoMonteCarlo.tex}

% -
% C1S3 - Discretização
% - 

\include{USPSC-TA-Textual/C2-SimulacoesEAlgoritmos/Discretizacao.tex}

% ---
% Capítulo 3 -Implementação e Resultados
% ---

\include{USPSC-TA-Textual/C3-ImplementacaoEResultados/C3-ImplementacaoEResultados.tex}

% -
% C3S1 - A implementação
% - 
\section{A implementação}
\include{USPSC-TA-Textual/C3-ImplementacaoEResultados/Implementacao.tex}

% -
% C3S2 - Validação em distribuições conhecidas
% - 
\section{Validação em distribuições conhecidas}
\include{USPSC-TA-Textual/C3-ImplementacaoEResultados/ValidacaoDistsConhecidas.tex}

% -
% C3S3 - Outros Potenciais?
% - 
\section{Outros Potenciais}
\include{USPSC-TA-Textual/C3-ImplementacaoEResultados/OutrosPotenciais.tex}

% ---
% Capítulo 4 - Conclusão
% ---

\include{USPSC-TA-Textual/C4-Conclusao/C4-Conclusao.tex}
