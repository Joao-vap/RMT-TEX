...
\tituloresumo{Matrizes aleatórias e simulação de Gases de Coulomb}
\autor{João Victor Alcantara Pimenta}
\autorficha{João Victor Alcantara Pimenta}
\autorabr{PIMENTA, J. V. A.}
...
\orientador{Prof. Dr. Guilherme L. F. Silva, Instituto de Ciências Matemáticas e de Computação (ICMC-USP)}
\orientadorcorpoficha{orientador Guilherme Silva}
\orientadorficha{SILVA, GUILHERME L. F., orientador}
